...
@interface TuTaoExample ()
@property (nonatomic, strong) NSMutableArray *titles;
@property (nonatomic, strong) NSMutableArray *classNames;
@end

@implementation TuTaoExample
...
- (void)viewDidLoad {
    ...
    self.title = @"TuTao Demo";
    self.titles = @[].mutableCopy;
    self.classNames = @[].mutableCopy;
    [self addCell:@"设备信息" class:@"TuTaoDeviceViewController"];
    [self addCell:@"DEMO" class:@"UIViewController"];
    [self addCell:@"DEMO" class:@"UIViewController"];
    [self addCell:@"DEMO" class:@"UIViewController"];
